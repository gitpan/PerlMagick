# This Makefile is for the Image::Magick extension to perl.
#
...
#     BUILD_REQUIRES => {  }
#     CCFLAGS => q[-I/usr/local/include/ImageMagick -fopenmp -fopenmp -g -O2 -Wall -pthread -D_REENTRANT -D_GNU_SOURCE -fno-strict-aliasing -pipe -fstack-protector -I/usr/local/include -D_LARGEFILE_SOURCE -D_FILE_OFFSET_BITS=64]
#     DEFINE => q[ -D_LARGE_FILES=1 -DHAVE_CONFIG_H]
...
#     PREREQ_PM => {  }
#     VERSION => q[6.6.7]
#     test => { TESTS=>q[t/*.t t/bzlib/*.t t/jpeg/*.t t/jng/*.t t/jp2/*.t t/png/*.t t/tiff/*.t t/x11/*.t t/zlib/*.t] }
...
MAKE = make
FULLEXT = Image/Magick
BASEEXT = Magick
PARENT_NAME = Image
DLBASE = $(BASEEXT)
VERSION_FROM = 
INC = -I/usr/local/include/ImageMagick -I../ -I.. -I"/usr/include/ImageMagick" 
DEFINE =  -D_LARGE_FILES=1 -DHAVE_CONFIG_H
...
TO_INST_PM = Magick.pm

PM_TO_BLIB = Magick.pm \
	$(INST_LIB)/Image/Magick.pm
...
XSPROTOARG = 
XSUBPPDEPS = /usr/share/perl5/ExtUtils/typemap $(XSUBPP)
...
DISTNAME = Image-Magick
DISTVNAME = Image-Magick-6.6.7
...
CCFLAGS = -I/usr/local/include/ImageMagick -fopenmp -fopenmp -g -O2 -Wall -pthread -D_REENTRANT -D_GNU_SOURCE -fno-strict-aliasing -pipe -fstack-protector -I/usr/local/include -D_LARGEFILE_SOURCE -D_FILE_OFFSET_BITS=64
...
manifypods : pure_all  \
	...
	$(NOECHO) $(POD2MAN) --section=3 --perm_rw=$(PERM_RW) \
	  Magick.pm $(INST_MAN3DIR)/Image::Magick.$(MAN3EXT) 
...
metafile : create_distdir
	...
	$(NOECHO) $(ECHO) 'name:               Image-Magick' >> META_new.yml
	$(NOECHO) $(ECHO) 'version:            6.6.7' >> META_new.yml
	$(NOECHO) $(ECHO) 'abstract:           ImageMagick PERL Extension' >> META_new.yml
	$(NOECHO) $(ECHO) 'author:' >> META_new.yml
	$(NOECHO) $(ECHO) '    - ImageMagick Studio LLC' >> META_new.yml
...
TEST_FILE = test.pl
TEST_FILES = t/*.t t/bzlib/*.t t/jpeg/*.t t/jng/*.t t/jp2/*.t t/png/*.t t/tiff/*.t t/x11/*.t t/zlib/*.t
TESTDB_SW = -d
...
ppd :
	$(NOECHO) $(ECHO) '<SOFTPKG NAME="$(DISTNAME)" VERSION="6.6.7">' > $(DISTNAME).ppd
	$(NOECHO) $(ECHO) '    <ABSTRACT>ImageMagick PERL Extension</ABSTRACT>' >> $(DISTNAME).ppd
	$(NOECHO) $(ECHO) '    <AUTHOR>ImageMagick Studio LLC</AUTHOR>' >> $(DISTNAME).ppd
